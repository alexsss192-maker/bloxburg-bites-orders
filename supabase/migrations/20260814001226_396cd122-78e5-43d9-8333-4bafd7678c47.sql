-- ============================================================
-- Remove order quantity limits (bulk / Fast Service)
-- Run in Supabase SQL Editor
-- ============================================================

-- 1) PREVIEW TOTAL (was filtering qty <= 100)
...
-- 2) PLACE ORDER (was: qty > 100 → Invalid quantity; cart max 50 lines)
...
BEGIN
  ...
  -- No artificial line-count limit for bulk (was 50)
  IF _items IS NULL
