                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    {isSkippeStocked(item) && (
                      <span className="mt-1.5 inline-flex items-center gap-1 rounded-full border border-cherry/25 bg-cherry/5 px-2 py-0.5 text-[0.65rem] font-semibold text-cherry">
