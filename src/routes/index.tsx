  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:title",
        content:
          "Panda Bites — Bloxburg kitchen for Discord members",
      },
      {
        property: "og:description",
        content:
          "Seasonal and non-seasonal Bloxburg bites, cooked by our chefs and paid in B$.",
      },
      {
        property: "og:type",
        content: "website",
          ...
          <div className="relative mx-auto max-w-7xl px-6 pt-10 md:pt-16">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-ink/10 pb-4 text-[0.7rem] uppercase tracking-[0.35em] text-ink/60">
              ...
              <span className="hidden md:inline">
                Panda Bites Magazine · Bloxburg Kitchen Quarterly
              </span>

              {/* IMPORTANT:
                  Keep this value deterministic during SSR/hydration.
                  Do not use new Date().toLocaleDateString() here.
              */}
            ...
            <div className="grid gap-12 pb-24 pt-12 md:grid-cols-[1.35fr_1fr] md:pt-16">
              ...
              <div className="flex flex-col justify-center">
                ...
                >
                  Panda Bites is a Discord-run kitchen serving fresh
                  Bloxburg foods. Order in
                  <span className="font-semibold text-ink">
                    {" "}
                    B${" "}
                  </span>
                  delivered in-game by chefs who actually care.
                </motion.p>
              ...
              >
                ...
                <div className="blossom-shadow relative overflow-hidden rounded-[2.25rem] border border-ink/10 bg-gradient-to-br from-blossom via-cream to-petal p-6">
                  ...
                  <p className="mt-1 text-xs uppercase tracking-[0.3em] text-cherry">
                    The Blossom Issue
                  </p>
...
function Article({
  ...
  return (
    ...
    >
      <p className="text-[0.7rem] uppercase tracking-[0.3em] opacity-70">
        {tag}
      </p>

      <h3 className="mt-4 font-display text-3xl leading-tight text-balance">
        {title}
      </h3>
