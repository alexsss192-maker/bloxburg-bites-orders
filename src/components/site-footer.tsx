        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm text-cream/60">
              A Discord kitchen serving Bloxburg's cutest bites. Pay in B$, delivered in-game
              by our chef team.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><a href="https://seasonalfoods.lovable.app/" target="_blank" rel="noreferrer" className="hover:text-cream">Seasonal shop ↗</a></li>
