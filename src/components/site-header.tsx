...
import { ShoppingBag, History, Moon, Sun } from "lucide-react";
      ...
      <header className="sticky top-0 z-30 border-b border-border/70 bg-cream/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link to="/" className="flex items-center gap-2">
            <span className="grid h-9 w-9 place-items-center rounded-full bg-ink text-cream text-lg">
              🐼
            </span>
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={toggleTheme}
              className="grid h-10 w-10 place-items-center rounded-full border border-border bg-card text-ink transition hover:bg-petal hover:text-cherry"
              aria-label={
            ...
            <Link
              to="/history"
              className="grid h-10 w-10 place-items-center rounded-full border border-border bg-card text-ink hover:bg-cherry hover:text-cream md:hidden"
              aria-label="Orders"
            >
